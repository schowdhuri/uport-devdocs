        ...
        <div className='building-blocks-wrapper'>
          ...
          <div className={'Grid Grid--gutters'}>
            <div>
              ...
              <div>
                <a className='block-item' href='/categories/uport-connect'>
                ...
                <a className='block-item' href='/categories/uport-credentials'>
                ...
                <a className='block-item' href='/categories/uport-transports'>
            ...
            <div>
              ...
              <div>
                <a className='block-item' href='/categories/ethr-did'>
                ...
                <a className='block-item' href='/categories/ethr-did-registry'>
